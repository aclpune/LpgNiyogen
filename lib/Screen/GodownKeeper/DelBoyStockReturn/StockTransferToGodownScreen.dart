...
class _StockTransferTOGodownScreenState extends State<StockTransferTOGodownScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //       children: [
    //         // Your other widgets like text fields or rows here
    //         // First Row: Item Name and Filled Stock
    //         Row(
    ...
    //         SizedBox(height: 5),
    //
    //         // Second Row: Empty Stock and Defective Stock
    //         Row(
    //           mainAxisAlignment: MainAxisAlignment.spaceBetween,
    //           children: [
    ...
    //         ),
    //
    //         // Other rows for Empty Qty, Defective Qty, etc...
    //
    //         SizedBox(height: 20),
    //
    //         // Submit Button
    ...
    //           ),
    //         ),
    //         // Now we only make the ListView scrollable
    //         Expanded( // This makes ListView take available space
    //           child: ListView.builder(
    //             shrinkWrap: true, // Takes only the space needed by the ListView
    //             physics: AlwaysScrollableScrollPhysics(), // Allows scrolling inside ListView
