          ...
          if (selectedItemId != 0) {
            ...
            getVendorMasterList().whenComplete((){
              _selectVendor = vendorModel.firstWhere(
                    (item) => item.vendorName == staffNameEdit,
                   ...
                   children: [
                     ...
                     Expanded(
                       child: TextField(
                         ...
                         inputFormatters: <TextInputFormatter>[
                           LengthLimitingTextInputFormatter(5),  // Maximum 5 characters (HH:mm)
                           //TimeInputFormatter(),  // Custom time formatter
                         ],
                         decoration: InputDecoration(
                           labelText: 'Time',
                         ),
          ...
          Expanded(
           ...
           Row(
             ...
             children: [
               ...
               //
               //     decoration: InputDecoration(
               //       hintText: 'Total Amount', // Set the hint text here
               //     ),
               //   ),
               // ),
               Flexible(
