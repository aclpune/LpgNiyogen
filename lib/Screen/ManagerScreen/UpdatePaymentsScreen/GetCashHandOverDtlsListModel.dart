...
class GetCashHandOverDtlsListModel {
  GetCashHandOverDtlsListModel({
      num? handoverId, 
      num? distributorId, 
      num? totalAmount, 
  ...
  GetCashHandOverDtlsListModel.fromJson(dynamic json) {
...
GetCashHandOverDtlsListModel copyWith({  num? handoverId,
  num? distributorId,
  num? totalAmount,
  dynamic handoverFromId,
  num? handoverToType,
  ...
  num? handoverStatus,
  num? totalHandoverAmt,
}) => GetCashHandOverDtlsListModel(  handoverId: handoverId ?? _handoverId,
