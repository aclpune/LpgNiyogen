...
class GetDashboardFyGrossProfitDtlsModel {
  GetDashboardFyGrossProfitDtlsModel({
      num? april, 
      num? may, 
      num? june, 
      num? july, 
  ...
  GetDashboardFyGrossProfitDtlsModel.fromJson(dynamic json) {
    _april = json['April'];
    _may = json['May'];
    _june = json['June'];
    _july = json['July'];
  ...
  num? _february;
  num? _march;
GetDashboardFyGrossProfitDtlsModel copyWith({  num? april,
  num? may,
  num? june,
  num? july,
  num? august,
  ...
  num? february,
  num? march,
}) => GetDashboardFyGrossProfitDtlsModel(  april: april ?? _april,
  may: may ?? _may,
  june: june ?? _june,
  july: july ?? _july,
