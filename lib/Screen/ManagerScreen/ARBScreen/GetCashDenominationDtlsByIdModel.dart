...
class GetCashDenominationDtlsByIdModel {
  GetCashDenominationDtlsByIdModel({
      num? salaryEntryId, 
      num? pSVId, 
      num? aRBSalesId, 
      num? aRBPurId, 
  ...
  GetCashDenominationDtlsByIdModel.fromJson(dynamic json) {
...
GetCashDenominationDtlsByIdModel copyWith({  num? salaryEntryId,
  num? pSVId,
  num? aRBSalesId,
  num? aRBPurId,
  num? distributorId,
  ...
  num? totalAmount,
  num? totalAmountminus,
}) => GetCashDenominationDtlsByIdModel(  salaryEntryId: salaryEntryId ?? _salaryEntryId,
  pSVId: pSVId ?? _pSVId,
