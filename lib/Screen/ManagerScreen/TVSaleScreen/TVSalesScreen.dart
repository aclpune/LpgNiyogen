...
class _TVSalesScreenState extends State<TVSalesScreen> {
  ...
  final TextEditingController _cylReceiveQtyController =
      TextEditingController();
  final TextEditingController _cylHoldingQtyController =
      TextEditingController();
  final TextEditingController _depositAmountPaidController =
      TextEditingController();
  final TextEditingController _refillGasPaymentController =
      TextEditingController();
  final TextEditingController _paymentAmountController =
      TextEditingController();
  final TextEditingController _paymentRemarkController =
      TextEditingController();
  final TextEditingController _transactionRemarkController =
      TextEditingController();
      ...
      if (argValue != null) {
        ...
        if (bankIdV != null &&
          ...
          final match = bankModel.firstWhere(
            ...
            // Convert bankId to string before calling trim()
            orElse: () =>
          ...
          if ((match.bankId?.toString() ?? '').isNotEmpty) {
            // Convert bankId to string for comparison
            setState(() {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                          child:
                              textWidgetBlueColorWithoutStar('Cash In Hand')),
                      Flexible(
                        flex: 1,
                        child: Text(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                          child: textWidgetBlueColorWithoutStar('TV Date')),
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              selectedReferredID = value?.staffId!
                                  .toInt(); // value is of type GetStaffDetailsListModel?
                              selectedReferredName = value?.staffName!
                                  .toString(); // value is of type GetStaffDetailsListModel?
                            });
                          },
                          isExpanded: true,
                        ),
                      ...
                      Flexible(
                        ...
                        child: DropdownButtonFormField<GetItemMasterListModel>(
                          ...
                          items: masterListModel
                              .map((GetItemMasterListModel staff) {
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                ...
                                onTap: () {
                                  _formKeyCylHoldQty.currentState!
                                      .validate(); // 👈 Validate on field submit
                                },
                              ),
                            ],
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                ...
                                onTap: () {
                                  _formKeyCylReceQty.currentState!
                                      .validate(); // 👈 Validate on field submit
                                },
                              ),
                            ],
                  ...
                  Row(
                    children: [
                      Expanded(
                          child:
                              textWidgetBlueColorWithStar("Payment Mode", "*")),
                      Flexible(
                        flex: 1,
                        child: DropdownButtonFormField<String>(
                          key: formKey4,
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(
                                child: textWidgetBlueColorWithoutStar("Time")),
                            Flexible(
                              flex: 1,
                              child: TextField(
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () {
                                                  loadDenominationData(
                                                      tvSale.tVId!.toInt());
                                                  var ptvID =
                                                      tvSale.tVId.toString();
                                                  var sVDate =
                                                      tvSale.tVDate.toString();
                                                  var staffId =
                                                      tvSale.staffId.toString();
                                                  var staffName = tvSale
                                                      .staffName
                                                      .toString();
                                                  var consumerNumber = tvSale
                                                      .consumerNo
                                                      .toString();
                                                  var consumerName = tvSale
                                                      .consumerName
                                                      .toString();
                                                  var itemId =
                                                      tvSale.itemId.toString();
                                                  var itemName = tvSale.itemName
                                                      .toString();
                                                  var cylHoldingQty = tvSale
                                                      .clyHoldQty
                                                      .toString();
                                                  var cylReceiveQty = tvSale
                                                      .clyReceivedQty
                                                      .toString();
                                                  var isRegulator = tvSale
                                                      .isRegulator
                                                      .toString();
                                                  var depositAmount = tvSale
                                                      .depositAmt
                                                      .toString();
                                                  var refillGasAmount = tvSale
                                                      .refillGasAmt
                                                      .toString();
                                                  var paymentAmount =
                                                      tvSale.paidAmt.toString();
                                                  var paymentMode = tvSale
                                                      .paymentMode
                                                      .toString();
                                                  var bankId =
                                                      tvSale.bankId.toString();
                                                  var bankMappingId = tvSale
                                                      .bankMappingId
                                                      .toString();
                                                  var transactionCode = tvSale
                                                      .transactionCode
                                                      .toString();
                                                  var transactionTime = tvSale
                                                      .transactionTime
                                                      .toString();
                                                  var transactionRemark = tvSale
                                                      .transactionRemark
                                                      .toString();
                                                  var addedBy =
                                                      tvSale.addedBy.toString();
                                                  var action =
                                                      tvSale.action.toString();
                                                  var remark =
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          setState(() {
            cashdatamodel = data
                .map((jsonItem) =>
                    GetCashHandOverDtlsListModel.fromJson(jsonItem))
                .toList();
            isLoading = false;
        ...
        if (modes == "Edit") {
          if (editPaymentMode == "Cash") {
            ...
            if (payAmount > totalCash!) {
              showFlushBar(context,
                  "Payment Amount Can Not Be Greater Than Cash In Hand Amount.");
              return;
            }
          } else {
    ...
    if (Constants.isNetworkAvailable) {
      ...
      try {
        final response = await http.get(
          ...
          Uri.parse(
              '${AppUrl.GetTVEntryCashDenominationDtl}/$tvId/$distributorId'),
          headers: {
            'Authorization': 'Bearer $token', // Add the Bearer token here
            // Any other headers you need can go here
          },
        ...
        if (response.statusCode == 200) {
          ...
          setState(() {
            getDenominationLis = data
                .map((json) => DenominationListForTvModel.fromJson(json))
                .toList();
            isLoading = false;
            // initializeControllers();
          });
  ...
  void cancelAction() {
    ...
    Navigator.pushNamed(
        context, TVSalesScreen.screenName // This opens the third tab
        );
  }
