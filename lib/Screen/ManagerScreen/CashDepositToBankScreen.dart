...
class CashDepositToBankScreen extends StatefulWidget {
  static const screenName = '/cashDepositToBankScreen';
  const CashDepositToBankScreen({super.key, this.httpClient});

  final http.Client? httpClient;

  @override
  State<CashDepositToBankScreen> createState() => _CashDepositToBankScreenState();
}

class _CashDepositToBankScreenState extends State<CashDepositToBankScreen> {
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text('Cash Deposit To Bank', style: AppTypography.cardTitle.copyWith(color: AppColors.white)),
                  const SizedBox(height: 2),
                  Text('Record deposit details and denomination', style: AppTypography.heroSubtitle),
                ],
              ),
            ),
            Padding(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.calendar_today, color: AppColors.blueLight),
                          SizedBox(width: 8),
                          Text(
                            'Deposit Date :',
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          InkWell(
                            ...
                            child: const Icon(Icons.date_range, color: AppColors.blueLight),
                          ),
                        ],
                      ),
                    ],
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.person, color: AppColors.blueLight),
                          SizedBox(width: 8),
                          Text(
                            'Deposited By:',
                            style: AppTypography.cardTitle,
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.monetization_on, color: AppColors.blueLight),
                          SizedBox(width: 8),
                          Text(
                            'Cash In Hand:',
                            style: AppTypography.cardTitle,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: ['State Bank of India', 'HDFC Bank Ltd']
