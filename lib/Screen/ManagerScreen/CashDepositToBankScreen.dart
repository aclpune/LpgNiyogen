...
class CashDepositToBankScreen extends StatefulWidget {
  ...
  const CashDepositToBankScreen({super.key});
...
class _CashDepositToBankScreenState extends State<CashDepositToBankScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //                     child: Text('Deposit Date :',style: TextStyle(fontWeight: FontWeight.bold),),
      //                   ),
      //                   Text(
      //                     _selectedDate == null
      //                         ? "No date selected"
      ...
      //             Padding(
      //               padding: const EdgeInsets.all(8.0),
      //               child: Text('Deposited By:',style: TextStyle(fontWeight: FontWeight.bold,)),
      //             ),
      //             SizedBox(
      ...
      //                                       child: Center(
      //                                           child:
      //                                           TextField(controller:quantity500Controller,
      //                                             style: TextStyle(
      //                                                 fontWeight:
      //                                                 FontWeight
      //                                                     .normal,
