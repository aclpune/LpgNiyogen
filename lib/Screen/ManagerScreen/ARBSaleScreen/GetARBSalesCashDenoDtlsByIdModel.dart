...
class GetArbSalesCashDenoDtlsByIdModel {
  GetArbSalesCashDenoDtlsByIdModel({
      num? salaryEntryId, 
      num? pSVId, 
      num? aRBSalesId, 
      num? aRBPurId, 
  ...
  GetArbSalesCashDenoDtlsByIdModel.fromJson(dynamic json) {
...
GetArbSalesCashDenoDtlsByIdModel copyWith({  num? salaryEntryId,
  num? pSVId,
  num? aRBSalesId,
  num? aRBPurId,
  num? distributorId,
  ...
  num? totalAmount,
  num? totalAmountminus,
}) => GetArbSalesCashDenoDtlsByIdModel(  salaryEntryId: salaryEntryId ?? _salaryEntryId,
  pSVId: pSVId ?? _pSVId,
