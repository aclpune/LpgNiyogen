...
class RspAmountOfItemListModel {
  RspAmountOfItemListModel({
      num? rSPId, 
      num? distributorId, 
      num? itemId, 
      String? itemName, 
  ...
  RspAmountOfItemListModel.fromJson(dynamic json) {
    _rSPId = json['RSPId'];
  ...
  num? _addedBy;
  dynamic _action;
RspAmountOfItemListModel copyWith({  num? rSPId,
  num? distributorId,
  num? itemId,
  String? itemName,
  num? rSPPrice,
  ...
  num? addedBy,
  dynamic action,
}) => RspAmountOfItemListModel(  rSPId: rSPId ?? _rSPId,
