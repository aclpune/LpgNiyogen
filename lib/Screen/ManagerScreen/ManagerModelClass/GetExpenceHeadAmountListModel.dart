...
class GetExpenceHeadAmountListModel {
  ...
  GetExpenceHeadAmountListModel.fromJson(dynamic json) {
  ...
  num? _isActive;
  dynamic _action;
GetExpenceHeadAmountListModel copyWith({  num? expHeadId,
  num? distributorId,
  String? expHeadName,
  num? parentHeadId,
  String? parentHeadName,
  ...
  num? isActive,
  dynamic action,
}) => GetExpenceHeadAmountListModel(  expHeadId: expHeadId ?? _expHeadId,
