      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _consumerController.text.isNotEmpty ? AppColors.blue : Colors.grey,
                        foregroundColor: Colors.white,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                      ),
                      child: Text('Add', style: AppTypography.alertValue.copyWith(color: Colors.white, fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],
            ...
            Container(
              decoration: BoxDecoration(
                border: Border.all(width: 1, color: AppColors.blue.withOpacity(0.3)),
                  ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [AppColors.blue, Color(0xFF0d6a9a)],
                    ...
                    child: Row(
                      children: [
                        Expanded(
                            ...
                            child: Center(
                                child: Padding(
                                  ...
                                  child: Text("Cons.No.",
                                      style: AppTypography.alertValue.copyWith(color: Colors.white, fontWeight: FontWeight.bold)),
                                ))),
                        ...
                        Expanded(
                            ...
                            child: Center(
                                child: Text("",
                                    style: AppTypography.alertValue.copyWith(color: Colors.white)))),
                      ],
                    ),
                  ),
                  ListView.builder(
