...
import 'CutomeAppBarManagerBottomNavigationBar.dart';
...
class CustomAppBarManager extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppBarManager({required this.title, super.key});
...
class CustomAppBarManagerr extends StatelessWidget implements PreferredSizeWidget {
  final String title;

  const CustomAppBarManagerr({required this.title, super.key});
